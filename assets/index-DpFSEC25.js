...
let __tla = Promise.all([
    ...
    function T({ children: i, isPresent: l }) {
        const e = t.useId(), n = t.useRef(null), C = t.useRef({
            width: 0,
            height: 0,
            top: 0,
            left: 0
        }), { nonce: a } = t.useContext($);
    ...
    H = ({ children: i, custom: l, initial: e = !0, onExitComplete: n, presenceAffectsLayout: C = !0, mode: a = "sync", propagate: f = !1 })=>{
        const [o, h] = S(f), s = t.useMemo(()=>w(i), [
            i
        ]), c = f && !o ? [] : s.map(R), d = t.useRef(!0), x = t.useRef(s), g = z(()=>new Map), [k, I] = t.useState(s), [p, P] = t.useState(s);
        A(()=>{
            d.current = !1, x.current = s;
            for(let u = 0; u < p.length; u++){
                const r = R(p[u]);
                c.includes(r) ? g.delete(r) : g.get(r) !== !0 && g.set(r, !1);
            }
        }, [
            p,
            c.length,
        ...
        return y.jsx(y.Fragment, {
            children: p.map((u)=>{
                const r = R(u), m = f && !o ? !1 : s === p || c.includes(r), M = ()=>{
                    if (g.has(r)) g.set(r, !0);
                    else return;
                    let j = !0;
                    g.forEach((L)=>{
                        L || (j = !1);
                    }), j && (E?.(), P(x.current), f && h?.(), n && n());
                };
                return y.jsx(U, {
                    isPresent: m,
