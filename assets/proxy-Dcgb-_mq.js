import { r as S, j as he, __tla as __tla_0 } from "./index-eVjePRSC.js";
let As, bs, De, eo, to, Mu, Qi;
let __tla = Promise.all([
    ...
    let Me, j;
    Me = typeof window < "u";
    eo = Me ? S.useLayoutEffect : S.useEffect;
    j = (t)=>t;
    let ws = j;
    function Re(t) {
        let e;
    ...
    const ct = (t, e, n)=>{
        const s = e - t;
        return s === 0 ? 1 : (n - t) / s;
    }, $ = (t)=>t * 1e3, z = (t)=>t / 1e3, no = {
        useManualTiming: !1
    };
    function so(t) {
        let e = new Set, n = new Set, s = !1, i = !1;
        const r = new WeakSet;
        let o = {
            delta: 0,
            timestamp: 0,
        ...
        const l = {
            ...
            process: (u)=>{
                ...
                s = !0, [e, n] = [
                    n,
                    e
                ], e.forEach(a), e.clear(), s = !1, i && (i = !1, l.process(u));
            }
        };
        return l;
    }
    ...
    function Vs(t, e) {
        ...
        const i = {
            ...
            timestamp: 0,
            isProcessing: !1
        }, r = ()=>n = !0, o = Lt.reduce((g, v)=>(g[v] = so(r), g), {}), { read: a, resolveKeyframes: l, update: u, preRender: c, render: h, postRender: f } = o, d = ()=>{
            const g = performance.now();
            n = !1, i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, io), 1), i.timestamp = g, i.isProcessing = !0, a.process(i), l.process(i), u.process(i), c.process(i), h.process(i), f.process(i), i.isProcessing = !1, n && e && (s = !1, t(d));
        }, m = ()=>{
            n = !0, s = !0, i.isProcessing || t(d);
        };
        return {
            schedule: Lt.reduce((g, v)=>{
                const T = o[v];
                return g[v] = (b, P = !1, w = !1)=>(n || m(), T.schedule(b, P, w)), g;
            }, {}),
            cancel: (g)=>{
    ...
    const { schedule: V, cancel: Y, state: E, steps: Jt } = Vs(typeof requestAnimationFrame < "u" ? requestAnimationFrame : j, !0), Cs = S.createContext({
        strict: !1
    }), un = {
        animation: [
            "animate",
    ...
    for(const t in un)ht[t] = {
        isEnabled: (e)=>un[t].some((n)=>!!e[n])
    };
    function oo(t) {
        for(const e in t)ht[e] = {
            ...ht[e],
            ...t[e]
        };
    }
    ...
    function lo(t, e, n) {
        const s = {};
        for(const i in t)i === "values" && typeof t.values == "object" || (Ds(i) || n === !0 && Ot(i) || !e && !Ot(i) || t.draggable && i.startsWith("onDrag")) && (s[i] = t[i]);
        return s;
    }
    function uo(t) {
        if (typeof Proxy > "u") return t;
        const e = new Map, n = (...s)=>t(...s);
        return new Proxy(n, {
    ...
    const Fe = (t)=>t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), po = "framerAppearId", Rs = "data-" + Fe(po), { schedule: Be } = Vs(queueMicrotask, !1), Es = S.createContext({});
    function go(t, e, n, s, i) {
        ...
        return eo(()=>{
            f && (m.current = !0, window.MotionIsMounted = !0, f.updateFeatures(), Be.render(f.render), y.current && f.animationState && f.animationState.animateChanges());
        }), S.useEffect(()=>{
    ...
    function vo({ preloadedFeatures: t, createVisualElement: e, useRender: n, useVisualState: s, Component: i }) {
        ...
        function a(u, c) {
            ...
            const f = {
                ...
                ...u,
                layoutId: xo(u)
            }, { isStatic: d } = f, m = ho(u), p = s(u, d);
            if (!d && Me) {
                To();
                const y = Po(f);
                h = y.MeasureLayout, m.visualElement = go(i, p, f, e, y.ProjectionNode);
            }
            return he.jsxs($t.Provider, {
                value: m,
                children: [
                    h && m.visualElement ? he.jsx(h, {
    ...
    function ke(t) {
        return typeof t != "string" || t.includes("-") ? !1 : !!(So.indexOf(t) > -1 || /[A-Z]/u.test(t));
    }
    function hn(t) {
        const e = [
            {},
    ...
    const dt = [
        ...
        "skewX",
        "skewY"
    ], st = new Set(dt), Bs = (t)=>(e)=>typeof e == "string" && e.startsWith(t), ks = Bs("--"), Co = Bs("var(--"), Ie = (t)=>Co(t) ? Do.test(t.split("/*")[0].trim()) : !1, Do = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, js = (t, e)=>e && typeof t == "number" ? e.transform(t) : t, H = (t, e, n)=>n > e ? e : n < t ? t : n, mt = {
        ...
        default: 1
            ...
            parse: parseFloat,
            transform: (e)=>`${e}${t}`
        }), X = Dt("deg"), K = Dt("%"), x = Dt("px"), Mo = Dt("vh"), Ro = Dt("vw"), fn = {
        ...K,
    ...
    function Ue(t, { attrX: e, attrY: n, attrScale: s, originX: i, originY: r, pathLength: o, pathSpacing: a = 1, pathOffset: l = 0, ...u }, c, h) {
        ...
        f.transform && (m && (d.transform = f.transform), delete f.transform), m && (i !== void 0 || r !== void 0 || d.transform) && (d.transformOrigin = No(m, i !== void 0 ? i : .5, r !== void 0 ? r : .5)), e !== void 0 && (f.x = e), n !== void 0 && (f.y = n), s !== void 0 && (f.scale = s), o !== void 0 && Oo(f, o, a, l, !1);
    }
    const _e = ()=>({
            style: {},
            transform: {},
            ...
            ..._e(),
            attrs: {}
        }), Ke = (t)=>typeof t == "string" && t.toLowerCase() === "svg";
    ...
    function We(t, e, n) {
        var s;
        const { style: i } = t, r = {};
        for(const o in i)(F(i[o]) || e.style && F(e.style[o]) || _s(o, t) || ((s = n?.getValue(o)) === null || s === void 0 ? void 0 : s.liveStyle) !== void 0) && (r[o] = i[o]);
        return r;
    }
    function Ks(t, e, n) {
        const s = We(t, e, n);
    ...
    function Ho(t, e, n, s) {
        const i = S.useMemo(()=>{
            const r = Is();
            return Ue(r, e, Ke(s), t.transformTemplate), {
                ...r.attrs,
                style: {
                    ...r.style
                }
    ...
    function Xo(t = !1) {
        return (n, s, i, { latestValues: r }, o)=>{
            const l = (ke(n) ? Ho : zo)(s, r, o, n), u = lo(s, typeof n == "string", t), c = n !== S.Fragment ? {
                ...u,
                ...l,
                ref: i
            } : {}, { children: h } = s, f = S.useMemo(()=>F(h) ? h.get() : h, [
                h
            ]);
    ...
    const ze = (t)=>Array.isArray(t) && typeof t[0] == "number", Qo = {
        linearEasing: void 0
    };
    function tr(t, e) {
        const n = Re(t);
    ...
    const gt = ([t, e, n, s])=>`cubic-bezier(${t}, ${e}, ${n}, ${s})`, me = {
        linear: "linear",
        ease: "ease",
        easeIn: "ease-in",
        easeOut: "ease-out",
    ...
    function qs(t, e) {
        const n = er(t), s = new AbortController, i = {
            passive: !0,
            ...e,
            signal: s.signal
        };
    ...
    const Zs = (t, e)=>e ? t === e ? !0 : Zs(t, e.parentElement) : !1, He = (t)=>t.pointerType === "mouse" ? typeof t.button != "number" || t.button <= 0 : t.isPrimary !== !1, sr = new Set([
        "BUTTON",
        "INPUT",
        "SELECT",
        "TEXTAREA",
    ...
    function rr(t, e, n = {}) {
        const [s, i, r] = qs(t, n), o = (a)=>{
            ...
            yt.add(l);
            const u = e(a), c = (d, m)=>{
                window.removeEventListener("pointerup", h), window.removeEventListener("pointercancel", f), !(!xn(d) || !yt.has(l)) && (yt.delete(l), typeof u == "function" && u(d, {
                    success: m
                }));
            }, h = (d)=>{
    ...
    const W = {
        now: ()=>(jt === void 0 && W.set(E.isProcessing || no.useManualTiming ? E.timestamp : performance.now()), jt),
        set: (t)=>{
    ...
    function gr(t, e, n, s, i) {
        let r, o, a = 0;
        do o = e + (n - e) / 2, r = ei(o, s, i) - t, r > 0 ? n = o : e = o;
    ...
    const ni = (t)=>(e)=>e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2, si = (t)=>(e)=>1 - t(1 - e), ii = Mt(.33, 1.53, .69, .99), Ze = si(ii), oi = ni(Ze), ri = (t)=>(t *= 2) < 1 ? .5 * Ze(t) : .5 * (2 - Math.pow(2, -10 * (t - 1))), Je = (t)=>1 - Math.sin(Math.acos(t)), ai = si(Je), li = ni(Je), ui = (t)=>/^0[^.\s]+$/u.test(t);
    function yr(t) {
    ...
    const xr = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, tn = (t, e)=>(n)=>!!(typeof n == "string" && xr.test(n) && n.startsWith(t) || e && !vr(n) && Object.prototype.hasOwnProperty.call(n, e)), ci = (t, e, n)=>(s)=>{
        ...
        transform: ({ red: t, green: e, blue: n, alpha: s = 1 })=>"rgba(" + te.transform(t) + ", " + te.transform(e) + ", " + te.transform(n) + ", " + xt(bt.transform(s)) + ")"
    };
    function Pr(t) {
        let e = "", n = "", s = "", i = "";
    ...
    const ge = {
        ...
        transform: ({ hue: t, saturation: e, lightness: n, alpha: s = 1 })=>"hsla(" + Math.round(t) + ", " + K.transform(xt(e)) + ", " + K.transform(xt(n)) + ", " + xt(bt.transform(s)) + ")"
    }, L = {
        test: (t)=>et.test(t) || ge.test(t) || rt.test(t),
        parse: (t)=>et.test(t) ? et.parse(t) : rt.test(t) ? rt.parse(t) : ge.parse(t),
    ...
    function gi() {
        if (xe) {
            const t = Array.from(nt).filter((s)=>s.needsMeasurement), e = new Set(t.map((s)=>s.element)), n = new Map;
            e.forEach((s)=>{
                const i = Ir(s);
        ...
        xe = !1, ve = !1, nt.forEach((t)=>t.complete()), nt.clear();
    }
    function yi() {
        nt.forEach((t)=>{
    ...
    class nn {
        ...
        scheduleResolve() {
            this.isScheduled = !0, this.isAsync ? (nt.add(this), ve || (ve = !0, V.read(yi), V.resolveKeyframes(gi))) : (this.readKeyframes(), this.complete());
        }
        readKeyframes() {
    ...
    const Vn = (t, e)=>e === "zIndex" ? !1 : !!(typeof t == "number" || Array.isArray(t) || typeof t == "string" && (q.test(t) || t === "0") && !t.startsWith("url("));
    function Kr(t) {
        const e = t[0];
    ...
    function Wr(t, e, n, s) {
        ...
        return !o || !a ? !1 : Kr(t) || (n === "spring" || $e(n)) && s;
    }
    const Gr = (t)=>t !== null;
    ...
    function zr({ hue: t, saturation: e, lightness: n, alpha: s }) {
        ...
        if (!e) i = r = o = n;
            ...
            const a = n < .5 ? n * (1 + e) : n + e - n * e, l = 2 * n - a;
    ...
    }, Yr = (t, e)=>(n)=>e(t(n)), Rt = (...t)=>t.reduce(Yr), Te = new Set([
        "none",
        "hidden"
    ]);
    function qr(t, e) {
    ...
    function bi(t, e) {
        const n = [
            ...t
        ], s = n.length, i = t.map((r, o)=>sn(r)(r, e[o]));
        return (r)=>{
    ...
    function aa(t) {
        ...
        if (!Mn(t, ra) && Mn(t, oa)) if (t.visualDuration) {
            const n = t.visualDuration, s = 2 * Math.PI / (n * 1.2), i = s * s, r = 2 * H(.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(i);
            e = {
                ...e,
                mass: D.mass,
                stiffness: i,
    ...
    function Ci(t = D.visualDuration, e = D.bounce) {
        ...
        const r = n.keyframes[0], o = n.keyframes[n.keyframes.length - 1], a = {
            ...
            value: r
        }, { stiffness: l, damping: u, mass: c, duration: h, velocity: f, isResolvedFromDuration: d } = aa({
            ...n,
            velocity: -z(n.velocity || 0)
        }), m = f || 0, p = u / (2 * Math.sqrt(l * c)), y = o - r, g = z(Math.sqrt(l / c)), v = Math.abs(y) < 5;
    ...
    function Rn({ keyframes: t, velocity: e = 0, power: n = .8, timeConstant: s = 325, bounceDamping: i = 10, bounceStiffness: r = 500, modifyTarget: o, min: a, max: l, restDelta: u = .5, restSpeed: c }) {
        const h = t[0], f = {
            done: !1,
            value: h
    ...
    const la = Mt(.42, 0, 1, 1), ua = Mt(0, 0, .58, 1), Di = Mt(.42, 0, .58, 1), ca = (t)=>Array.isArray(t) && typeof t[0] != "number", ha = {
        linear: j,
        easeIn: la,
        easeInOut: Di,
        easeOut: ua,
    ...
    function da(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
        const r = t.length;
    ...
    function Kt({ duration: t = 300, keyframes: e, times: n, ease: s = "easeInOut" }) {
        const i = ca(s) ? s.map(En) : En(s), r = {
            done: !1,
            value: e[0]
        }, o = ga(n && n.length === e.length ? n : pa(e), t), a = da(o, e, {
    ...
    class on extends Ai {
        constructor(e){
            ...
            const { name: n, motionValue: s, element: i, keyframes: r } = this.options, o = i?.KeyframeResolver || nn, a = (l, u)=>this.onKeyframesResolved(l, u);
        ...
        initPlayback(e) {
            ...
            let l, u;
            a !== Kt && typeof e[0] != "number" && (l = Rt(Ta, wi(e[0], e[1])), e = [
                0,
                100
            ]);
            const c = a({
            ...
            r === "mirror" && (u = a({
                ...
                velocity: -o
            })), c.calculatedDuration === null && (c.calculatedDuration = $s(c));
    ...
    class Ln extends Ai {
        ...
        initPlayback(e, n) {
            ...
            const c = Sa(a.owner.current, l, e, {
                ...this.options,
                duration: s,
                times: i,
                ease: r
    ...
    const Da = {
        ...
        duration: .3
    }, La = (t, { keyframes: e })=>e.length > 2 ? Ra : st.has(t) ? t.startsWith("scale") ? Ma(e[1]) : Da : Ea;
    ...
    function Ri(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
        ...
        for(const h in l){
            ...
            pe(t, h), f.start(rn(h, f, d, t.shouldReduceMotion && Js.has(h) ? {
                type: !1
            } : m, t, p));
            const y = f.animation;
            y && u.push(y);
    ...
    function ka(t, e, n = 0, s = 0, i = 1, r) {
        ...
        return Array.from(t.variantChildren).sort(ja).forEach((u, c)=>{
            u.notify("AnimationStart", e), o.push(Se(u, e, {
                ...r,
                delay: n + l(c)
    ...
    function Ka(t) {
        ...
        function o(l) {
            const { props: u } = t, c = Ei(t.parent) || {}, h = [], f = new Set;
            let d = {}, m = 1 / 0;
            for(let y = 0; y < Ua; y++){
                ...
                if (w && s && t.manuallyAnimateOnMount && (w = !1), v.protectedKeys = {
                    ...d
                }, !v.isActive && P === null || !T && !v.prevProp || zt(T) || typeof T == "boolean") continue;
                const R = Wa(v.prevProp, T);
                let A = R || g === l && v.isActive && !w && b || y > m && b, k = !1;
                const O = Array.isArray(T) ? T : [
                    T
                ];
                let it = O.reduce(i(g), {});
                P === !1 && (it = {});
                const { prevResolvedValues: an = {} } = v, Ji = {
                    ...an,
                    ...it
                }, ln = (B)=>{
                ...
                for(const B in Ji){
                    ...
                    let Zt = !1;
                    fe(G) && fe(qt) ? Zt = !Gs(G, qt) : Zt = G !== qt, Zt ? G != null ? ln(B) : f.add(B) : G !== void 0 && f.has(B) ? ln(B) : v.protectedKeys[B] = !0;
                }
                v.prevProp = T, v.prevResolvedValues = it, v.isActive && (d = {
                    ...d,
                    ...it
    ...
    class Li {
        constructor(e, n, { transformPagePoint: s, contextWindow: i, dragSnapToOrigin: r = !1 } = {}){
            if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = ()=>{
                ...
                const h = oe(this.lastMoveEventInfo, this.history), f = this.startEvent !== null, d = Ya(h.offset, {
                    x: 0,
                    y: 0
                }) >= 3;
                if (!f && !d) return;
                ...
                this.lastMoveEvent = h, this.lastMoveEventInfo = ie(f, this.transformPagePoint), V.update(this.updatePoint, !0);
    ...
    const Bi = 1e-4, Ja = 1 - Bi, Qa = 1 + Bi, ki = .01, tl = 0 - ki, el = 0 + ki;
    function I(t) {
        return t.max - t.min;
    }
    function nl(t, e, n) {
    ...
    function Un(t, e) {
        ...
        return e.max - e.min < t.max - t.min && ([n, s] = [
            s,
            n
        ]), {
            min: n,
    ...
    const Hn = .999999999999, Xn = 1.0000000000001;
    function fl(t, e, n, s = !1) {
        ...
        for(let a = 0; a < i; a++){
            ...
            l && l.props.style && l.props.style.display === "contents" || (s && r.options.layoutScroll && r.scroll && r !== r.root && ut(t, {
                x: -r.scroll.offset.x,
                y: -r.scroll.offset.y
            }), o && (e.x *= o.x.scale, e.y *= o.y.scale, Oi(t, o)), s && Q(r.latestValues) && ut(t, r.latestValues));
        }
    ...
    const Ui = ({ current: t })=>t ? t.ownerDocument.defaultView : null, ml = new WeakMap;
    class pl {
        constructor(e){
        ...
        resolveConstraints() {
            ...
            n && ot(n) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : n && i ? this.constraints = ol(i.layoutBox, n) : this.constraints = !1, this.elastic = ul(s), r !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && U((o)=>{
                this.constraints !== !1 && this.getAxisMotionValue(o) && (this.constraints[o] = ll(i.layoutBox[o], this.constraints[o]));
            });
        }
        ...
        startAxisValueAnimation(e, n) {
            ...
            return pe(this.visualElement, e), s.start(rn(e, s, 0, n, this.visualElement, !1));
        }
        stopAnimation() {
        ...
        getProps() {
            const e = this.visualElement.getProps(), { drag: n = !1, dragDirectionLock: s = !1, dragPropagation: i = !1, dragConstraints: r = !1, dragElastic: o = Ae, dragMomentum: a = !0 } = e;
            return {
                ...e,
                drag: n,
                dragDirectionLock: s,
    ...
    const Ki = [
        ...
        "BottomLeft",
        "BottomRight"
    ], Cl = Ki.length, Jn = (t)=>typeof t == "string" ? parseFloat(t) : t, Qn = (t)=>typeof t == "number" || x.test(t);
    ...
    const Ml = Wi(0, .5, ai), Rl = Wi(.5, .95, j);
    function Wi(t, e, n) {
    ...
    function El(t, e = 0, n = 1, s = .5, i, r = t, o = t) {
    ...
    }, vt = typeof window < "u" && window.MotionDebug !== void 0, ae = [
        "",
        "X",
        "Y",
        "Z"
        ...
        return class {
            constructor(o = {}, a = e?.()){
                this.id = Ol++, this.animationId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
                    ...
                    this.projectionUpdateScheduled = !1, vt && (tt.totalNodes = tt.resolvedTargetDeltas = tt.recalculatedProjection = 0), this.nodes.forEach(_l), this.nodes.forEach(zl), this.nodes.forEach(Hl), this.nodes.forEach(Kl), vt && window.MotionDebug.record(tt);
                }, this.resolvedRelativeTargetAt = 0, this.hasProjected = !1, this.isVisible = !0, this.animationProgress = 0, this.sharedNodes = new Map, this.latestValues = o, this.root = a ? a.root || a : this, this.path = a ? [
                    ...a.path,
                    a
            ...
            mount(o, a = this.root.hasTreeAnimated) {
                ...
                if (c && !c.current && c.mount(o), this.root.nodes.add(this), this.parent && this.parent.children.add(this), a && (u || l) && (this.isLayoutDirty = !0), t) {
                    ...
                    t(o, ()=>{
                        this.root.updateBlockedByResize = !0, h && h(), h = Vl(f, 250), It.hasAnimatedSinceResize && (It.hasAnimatedSinceResize = !1, this.nodes.forEach(ds));
                    });
                }
            ...
            update() {
                ...
                this.isUpdating || this.nodes.forEach(Gl), this.isUpdating = !1, this.nodes.forEach($l), this.nodes.forEach(Nl), this.nodes.forEach(Ul), this.clearAllSnapshots();
                const a = W.now();
            ...
            resetTransform() {
                ...
                o && (a || Q(this.latestValues) || c) && (i(this.instance, u), this.shouldResetTransform = !1, this.scheduleRender());
            }
            measure(o = !0) {
            ...
            setAnimationOrigin(o, a = !1) {
                ...
                const f = M(), d = l ? l.source : void 0, m = this.layout ? this.layout.source : void 0, p = d !== m, y = this.getStack(), g = !y || y.members.length <= 1, v = !!(p && !g && this.options.crossfade === !0 && !this.path.some(Zl));
            ...
            startAnimation(o) {
                this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (Y(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = V.update(()=>{
                    It.hasAnimatedSinceResize = !0, this.currentAnimation = Sl(0, hs, {
                        ...o,
                        onUpdate: (a)=>{
            ...
            getProjectionStyles(o) {
                ...
                if (this.needsReset) return this.needsReset = !1, u.opacity = "", u.pointerEvents = kt(o?.pointerEvents) || "", u.transform = c ? c(this.latestValues, "") : "none", u;
                const h = this.getLead();
                if (!this.projectionDelta || !this.layout || !h.target) {
                    const p = {};
                    return this.options.layoutId && (p.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, p.pointerEvents = kt(o?.pointerEvents) || ""), this.hasProjected && !Q(this.latestValues) && (p.transform = c ? c({}, "") : "none", this.hasProjected = !1), p;
                }
                ...
                return this.options.layoutId && (u.pointerEvents = h === this ? kt(o?.pointerEvents) || "" : "none"), u;
            }
            clearSnapshot() {
            ...
            if (!t.resumeFrom) {
                ...
                if (h && !h.resumeFrom) {
                    ...
                    if (f && d) {
                        ...
                        const p = M();
                        St(p, s, d.layoutBox), $i(m, p) || (c = !0), h.options.layoutRoot && (t.relativeTarget = p, t.relativeTargetOrigin = m, t.relativeParent = h);
                    }
                }
            }
    ...
    }, gs = (t)=>typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t), ys = gs("applewebkit/") && !gs("chrome/") ? Math.round : j;
    function vs(t) {
    ...
    function Xi(t, e, n) {
        return t === "position" || t === "preserve-aspect" && !nl(us(e), us(n), .2);
    }
    function tu(t) {
        var e;
    ...
    class ou extends Z {
        mount() {
            const { current: e } = this.node;
            e && (this.unmount = rr(e, (n)=>(Ts(this.node, n, "Start"), (s, { success: i })=>Ts(this.node, s, i ? "End" : "Cancel")), {
                useGlobalTarget: this.node.props.globalTapTarget
            }));
        }
        unmount() {}
    }
    const Ve = new WeakMap, ce = new WeakMap, ru = (t)=>{
    ...
    function lu({ root: t, ...e }) {
        ...
        return s[i] || (s[i] = new IntersectionObserver(au, {
            root: t,
            ...e
        })), s[i];
    }
    ...
    class hu extends Z {
        ...
        update() {
            ...
            [
                ...
                "margin",
                "root"
            ].some(fu(e, n)) && this.startObserver();
        }
        unmount() {}
    }
    ...
    function pu() {
        if (qi.current = !0, !!Me) if (window.matchMedia) {
    ...
    const gu = [
        ...
        L,
        q
    ], yu = (t)=>gu.find(Ti(t)), Ps = new WeakMap;
    function vu(t, e, n) {
        for(const s in e){
            const i = e[s], r = n[s];
            if (F(i)) t.addValue(s, i);
            else if (F(r)) t.addValue(s, wt(i, {
                owner: t
            }));
    ...
    class xu {
        ...
        constructor({ parent: e, props: n, presenceContext: s, reducedMotionConfig: i, blockInitialAnimation: r, visualState: o }, a = {}){
            ...
            this.onUpdate = c, this.latestValues = l, this.baseTarget = {
                ...
                ...l
            } : {}, this.renderState = u, this.parent = e, this.props = n, this.presenceContext = s, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = i, this.options = a, this.blockInitialAnimation = !!r, this.isControllingVariants = Ht(n), this.isVariantNode = Ms(n), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(e && e.current);
...
export { As as L, bs as M, De as P, eo as a, to as b, Mu as m, Qi as u, __tla };
